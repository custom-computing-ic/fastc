...
{
  device_name = (char*) malloc(100 * sizeof(char)); 
  //*device_name = (argc==2 ? argv[1] : "/dev/maxeler0");
  if(argc ==2)
    strcpy(device_name, argv[1]);
  else 
    strcpy(device_name, "/dev/maxeler0");
