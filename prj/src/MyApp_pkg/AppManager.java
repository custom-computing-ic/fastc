...
public class AppManager extends CustomManager {
    ...
    //  FPGA-0    
    KernelBlock k0   = addKernel(new do_forward(makeKernelParameters("MyApp0")));
    ...
    k0.getInput("pp").connect(dram2knl1);
    k0.getInput("dvv").connect(dram2knl2);
    k0.getInput("source").connect(dram2knl3);

    knl2dram0.connect(k0.getOutput("pp_out"));
    knl2dram1.connect(k0.getOutput("p_out"));
  }
}
