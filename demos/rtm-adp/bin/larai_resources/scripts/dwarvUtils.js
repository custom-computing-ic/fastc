importPackage(Packages.org.reflect.utils);
function dwarvsim(args){
	var myReport = new ReportDawrvSim();
	myReport.extract(args.file);
	var LARACode = myReport.getReportStr(args.design);
	return ''+LARACode.toString();
}
