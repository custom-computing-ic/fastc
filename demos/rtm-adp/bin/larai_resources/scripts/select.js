...
*/
function select(args, workspace){
	...
	var script = "";
	try{
		script = ""+((new org.reflect.weaving.Report()).getFilesAndFunctions(workspace, fileNameFilter, functionNameFilter));
	}catch(e){
			errorln("Exception when selecting on the workspace: "+ workspace+"\n\t"+e);
			throw null;
	}
