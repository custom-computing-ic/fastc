...
\begin{frame}[fragile]{3. Aspect Descriptions: Run-time Reconfiguration}
  \begin{itemize}
  \item Run-time reconfiguration can be used to remove idle functions
...
\begin{frame}[fragile]{3. Aspect Descriptions: Run-time Reconfiguration}
  ...
  \begin{columns}
    \begin{column}{.5\textwidth}
      Automatically add FAST pragmas based on partition information.
    \end{column}
    \begin{column}{.5\textwidth}
      {\footnotesize
      \begin{table}[!h]
