...
\begin{frame}{4. Evaluation}
  \frametitle{RTM Design Space Exploration}
  \begin{itemize}
...
\begin{frame}{4. Evaluation}
  ...
  \begin{itemize}
  \item   accuracy vs resource usage
  \item  2X parallelism, reduced accuracy
  \end{itemize}
  \begin{figure}
    \centering
    \begin{tikzpicture}[scale=0.8]
...
\begin{frame}{4. Evaluation}
  ...
  \begin{itemize}
  \item performance vs build time
  \item identify resource bottlenecks
  \end{itemize}
  \begin{figure}
    \centering
    \begin{tikzpicture}[scale=0.8]
...
\begin{frame}{4. Evaluation}
    ...
    \begin{table}
      ...
      \hspace*{-8pt}\makebox[\linewidth][c]{
        \begin{tabular}{c|p{0.55cm}|p{0.5cm}|p{0.6cm}|p{0.6cm}|p{0.65cm}|p{0.65cm}|p{0.65cm}|p{0.75cm}|p{0.65cm}}
          & \textbf{CPU} & \textbf{GPU} \cite{himeno} & \textbf{GPU} \cite{datta} & \textbf{GPU} \cite{cirque} & \textbf{FPGA} \cite{arraya}& \textbf{FPGA} \cite{xinyu}\ & \textbf{FPGA} & \textbf{FPGA D\footnote{D = Dynamic (i.e. using run-time reconfiguration)}} \cite{xinyu} & \textbf{FPGA D} \\
          \hline \hline
  ...
  \begin{itemize}
  \item can generate functionally identical dataflow design
