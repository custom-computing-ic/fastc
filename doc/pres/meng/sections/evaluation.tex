    ...
    \begin{table}
      ...
      \hspace*{-8pt}\makebox[\linewidth][c]{
        \begin{tabular}{c|p{0.55cm}|p{0.5cm}|p{0.6cm}|p{0.6cm}|p{0.65cm}|p{0.65cm}|p{0.65cm}|p{0.75cm}|p{0.65cm}}
          ...
          Speed-up(X)   & 1           & 56.8        &   40          &     71.6         &     39.7          & 76.4               & \textbf{74.2}     & 102.9              & \textbf{100.2}     \\
          Power (W)  & 185          & --        &    461          &      --        &         --      & 129                 & 126                 & 128                 & 125                 \\
          Efficiency & 4.9          & --        &    78          &       --       &    --           & 527.1               & 530.1               & 715.6               & 721.6               \\
          Eff. Gains & 1           & --        &    15.9          &        --      & --            & 107.5              & \textbf{108.1}     & 146.0             & \textbf{147.2}     \\
        \end{tabular}
      }
    \end{table}
