...
For an example of a 1D stencil consider the problem of numerical
differentiation, where the first derivative of a function can be
approximated by:
...
\begin{algorithm}
  \caption{Stencil kernel for Black Scholes PDE}
...
to detect geological structures beneath the Earth's surface
\cite{araya2011assessing} and is widely used in the Oil and Gas
