...
* We evaluate our approach using a static and a run-time
  reconfigurable implementation of a high performance application
...
* we convert the AST generated by ROSE into a data flow graph

* we traverse the data flow graph generating MaxJ code
