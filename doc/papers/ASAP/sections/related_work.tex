...
from the accelerated one, providing an imperative C based run-time
environment and a Java dataflow API for building the accelerator
designs. The separation complicates the development process, since
the two components have to be managed separately and hinders
information sharing between the two components (such as common design
parameters) and, consequently, the design space exploration process.
