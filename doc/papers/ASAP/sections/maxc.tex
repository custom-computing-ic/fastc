...
to specify the design (as in MaxCompiler
...
\item Supports data path and control path generation. \MAXC{} allows
  specifying both data and control operations that are automatically
  mapped to stream multiplexers.
\end{itemize}
