\begin{abstract}
  ...
  MaxC and show how inputs, outputs, computation and control parts of
  hardware designs can be captured with high-level MaxC descriptions,
  and simulated in software using the standard GCC stack. Optimisation
  strategies for the generated designs are then specified with LARA, a
  ...
  performance to state of the art FPGA implementations, while
