...
illustrate the trade-offs between accuracy and resource usage (Figure
\ref{fig:precision}). We observe irregular, large variations when
...
(Figure \ref{fig:arith}). This helps to avoid over mapping on DSPs for
...
implementation, Figure \ref{fig:scalability} shows that performance
...
Figure \ref{fig:scalability} also shows the performance benefits of
