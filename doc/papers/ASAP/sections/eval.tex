...
streams (CmdRead, CmdWrite) and the computation kernel (RTM).  To
illustrate the potential benefits of our approach we analyse the
...
\begin{figure}[!h]
\includegraphics[scale=0.75,trim=10 0 0 0]{figs/pre}
...
\begin{figure}[!h]
\includegraphics[scale=0.75,trim=10 0 0 0]{figs/arith}
