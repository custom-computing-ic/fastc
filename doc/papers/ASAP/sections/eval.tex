...
Finally, Figure \ref{fig:scalability} shows the performance benefits
of the RTM implementation that uses run-time reconfiguration. This is
generated by using the reconfiguration aspect to create two
