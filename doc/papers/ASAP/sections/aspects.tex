...
\end{lstlisting}
\caption{Exploration aspect that generates MaxC designs by varying a design attribute (e.g. number of kernels or mantissa) until a LUT threshold is reached.}
