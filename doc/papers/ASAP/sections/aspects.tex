...
program. AspectJ\cite{Kiczales:2005:AP:1062455.1062640}, an implementation of
Aspect-Oriented Programming (AOP) for the Java programming language,
captures program execution points (such as method calls) at run-time
to allow new code to be executed before, after or in place of these
execution points through a process called \emph{weaving}. The main
motivation behind AspectJ in particular, and AOP in general, is to
solve the modularization problem when dealing with multiple
