...
\author{
  \IEEEauthorblockN{
    ...
    \emph{Jos\'{e} Gabriel F. Coutinho}\IEEEauthorrefmark{1},
    \emph{Wayne Luk}\IEEEauthorrefmark{1} and
    \emph{Jacob Bower}\IEEEauthorrefmark{2} \vspace{0.1cm}
  }
  \IEEEauthorblockA{
    \IEEEauthorrefmark{1}
  ...
  \IEEEauthorblockA{
   Email: \{paul.grigoras09, niu.xinyu10, gabriel.figueiredo, w.luk\}@imperial.ac.uk, jacob@maxeler.com
  }
}
